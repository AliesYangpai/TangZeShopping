...
package org.tangze.work.widget.stickygridheaders;
...
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
    ...
    private PullableGridView mGridViewPull;
    ...
    public StickyGridHeadersBaseAdapterWrapper(Context context, PullableGridView gridView,
            StickyGridHeadersBaseAdapter delegate) {
        mContext = context;
        mDelegate = delegate;
        mGridViewPull = gridView;
